...
class WebserviceCaixa {
	...
	function __construct($args) {
		...
		$this->args = $this->TrimArray(array_merge($padroes,$args));
	...
	/**
	 * Aplica `trim` a todos os elementos de um array recursivamente
	 */
	 function TrimArray($e) {

		 return is_array($e) ? array_map(array($this, 'TrimArray'), $e) : trim($e);
	}
